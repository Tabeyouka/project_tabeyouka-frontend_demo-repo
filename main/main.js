(() => {
  ...
  const PointCalculation = (storePoint) => {
    ...
    if (storePoint === 5) {
      ...
      stars =
        '<div class="fa fa-star checked"></div>'.repeat(4) +
        '<div class="fa fa-star"></div>';
    } else if (storePoint >= 3 && storePoint < 4) {
      stars =
        '<div class="fa fa-star checked"></div>'.repeat(3) +
        '<div class="fa fa-star"></div>'.repeat(2);
    } else if (storePoint >= 2 && storePoint < 3) {
      stars =
        '<div class="fa fa-star checked"></div>'.repeat(2) +
        '<div class="fa fa-star"></div>'.repeat(3);
    } else if (storePoint >= 0.1 && storePoint < 2) {
      stars =
        '<div class="fa fa-star checked"></div>' +
        '<div class="fa fa-star"></div>'.repeat(4);
